<template>
	<UTable :columns="columns" :data="tableData" :ui="{
...
const lessonsThisWeek = ref<CampusDataSimple[]>([]);
...
const columns: TableColumn[] = [
	...
	{ key: "Monday", label: "Monday", id: "monday" },
	{ key: "Tuesday", label: "Tuesday", id: "tuesday" },
	{ key: "Wednesday", label: "Wednesday", id: "eednesday" },
	{ key: "Thursday", label: "Thursday", id: "thursday" },
	{ key: "Friday", label: "Friday", id: "friday" },
];
